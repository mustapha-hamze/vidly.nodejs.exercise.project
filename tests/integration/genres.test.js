...
describe("/api/genres", () => {
  ...
  afterEach(async () => {
    ...
    // it will remove all records in genre collection
    await Genre.remove({});
  });
  ...
  describe("Post /", () => {
    ...
    it("should return 400 if genre names is less than 5 characters", async () => {
      name = "abcd";
      const res = await exec();
    ...
    it("should return 400 if genre names is more than 50 characters", async () => {
